...
//در این اکشن پیش شماره برای اندروید ارسال می شود نکته: پیش شماره باید از جدولی مربوط به خودش استفاده شود که فعلا نشده
    ...
    public function actionAdsl_vdsl_pishshomare()
    {
        ...
        if (isset($_POST['type']) && $_POST['type'] != null) {
            ...
            if ($_POST['type'] == 'adsl' || $_POST['type'] == 'vdsl') {
                ...
                $pishshomare1 = TblPhone::find()->all();
...
//
                    ...
                    if ($chek_markaz != null) {
                        ...
                        foreach ($chek_markaz as $item) {
                            ...
                            if ($_POST['shomare'] >= $item->reng_az && $_POST['shomare'] <= $item->reng_ta) {
                                ...
                                $sendOk['chek_name'] = "مرکزی یافت نشد";
                                $send['chek'] = 3;
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
    ...
    // در این اکشن اطلاعات ارسالی از اندروید در فاکتور adsl  ذخیره می شود
//وضعیت ثبت اگر 1 بود به معنای ثبت نام کامل می باشد.    
//در این اکشن تاریخ ارسالی حتما باید با فرمت 12/12/1397 باشد یعنی با اسلش جدا شود
//adsl ,vdsl,owa,td-lte در یک فاکتور ذخیره می شود
...
//y= foroshe_tejari
    ...
    public function actionFactor_g_z()
    {
        ...
        if (isset($_POST['type']) && $_POST['type'] != null
            ...
            && isset($_POST['id_hozeye_faaliyat']) && $_POST['id_hozeye_faaliyat'] != null
            ...
            $model->id_hozeye_faaliyat = $_POST['id_hozeye_faaliyat'];
            ...
            if ($user != null) {
                ...
                if ($user->validatePassword($password)) {
                    ...
                    if ($profil->semat == $_POST['semat']) {
                        ...
                        $send['ax_perseneli'] = $profil->ax_perseneli;
                        $send['ax_kartmeli'] = $profil->ax_kartmeli;
...
//تغییرات من
    public function actionSignup()
    {
        if (isset($_POST['username']) && $_POST['username'] != null &&
            ...
            isset($_POST['name']) && $_POST['name'] != null &&
            isset($_POST['lastName']) && $_POST['lastName'] != null &&
            isset($_POST['hesab']) && $_POST['hesab'] != null &&
            isset($_POST['bank']) && $_POST['bank'] != null &&
            isset($_POST['role']) && $_POST['role'] != null &&
            isset($_POST['adress']) && $_POST['adress'] != null &&
            isset($_POST['code_meli']) && $_POST['code_meli'] != null
        ) {
            $userCheck = User::find()->where(['username' => $_POST['username']])->one();
            if ($userCheck) {
                $sendFull['result'] = 0;
                $sendFull['msg'] = "این نام کاربری قبلا ثبت شده است ";
                return $sendFull;
                exit;
            }
            $moaref = User::find()->where(['username' => $_POST['moaref']])->one();
            if ($_POST['moaref'] != "void") {
                if ($moaref == null) {
                    $sendFull['result'] = 0;
                    $sendFull['msg'] = "نام معرف اشتباه است ";
                    return $sendFull;
                    exit;
                }
            }
            ...
            $authorRole = $auth->getRole($_POST['role']);
            if ($user->save()) {
                $auth->assign($authorRole, $user->getId());
                $profile = new \frontend\models\Tblprofile();
                ...
                $profile->code_meli = $_POST['code_meli'];
                $profile->shomare_cart = $_POST['bank'];
                $profile->shomare_hesab = $_POST['hesab'];
                if ($_POST['moaref'] == "void") {
                    $profile->id_moaref = -1;
                } else {
                    $profile->id_moaref = $moaref->id;
                }
                $profile->username = "*********";

                if ($profile->save()) {
                    $sendFull['result'] = 1;
                    $sendFull['role'] = $_POST['role'];
                    return $sendFull;
                } else {
                    $user->delete();
                    $sendFull['result'] = 0;
                    $sendFull['msg'] = 'ثبت نام شما انجام نشد';
                    return $sendFull;
                }
            } else {
                $sendFull['result'] = 0;
                $sendFull['msg'] = 'در ذخیره اطلاعات خطای ناشناخته ای رخ داده است دوباره تلاش کنید';
                return $sendFull;
            }
        } else {
            $sendFull['result'] = 0;
            $sendFull['msg'] = 'اطلاعات ارسالی اشتباه است';
            return $sendFull;
        }
    }
    ...
    public function actionSignup2()
    {
        if (isset($_POST['username']) && isset($_POST['username']) &&
            ...
            isset($_POST['tell']) && isset($_POST['tell']) &&
            isset($_POST['moaref']) && isset($_POST['moaref']) &&
            isset($_POST['name']) && isset($_POST['name']) &&
            isset($_POST['lastName']) && isset($_POST['lastName']) &&
            isset($_POST['hesab']) && isset($_POST['hesab']) &&
            isset($_POST['bank']) && isset($_POST['bank']) &&
            isset($_POST['role']) && isset($_POST['role']) &&
            isset($_POST['adress']) && isset($_POST['adress'])
        ) {
            $userCheck = User::find()->where(['username' => $_POST['username']])->one();
            if ($userCheck) {
                $sendFull['result'] = 0;
...
//                        return $fa->date_farsi.$_POST['az_tarikh'] ;
                        if ($fa->date_farsi >= $_POST['az_tarikh'] && $fa->date_farsi <= $_POST['ta_tarikh']) {
...
//                    $sendOk['tahaqoq']=$send;
                ...
                if ($targetadsl != null) {
                    ...
                    foreach ($targetadsl as $ta) {
                        ...
                        if ($ta->datefa >= $_POST['az_tarikh'] && $ta->ta_date_farsi <= $_POST['ta_tarikh']) {
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['adsl'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['vdsl'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['owa'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['td-lte'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }

                        }
                        $sendOk['td_lte'] = $sendList;
                        $sendOk['result'] = 1;
                        return $sendOk;
                    }
                    else{
                        $sendOk['td-lte'] = ' موجود نیست';
                        $sendOk['result'] = 0;
                        return $sendOk;
                    }
                }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['iptv'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['ngn'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['mvno'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['cdn'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['vas'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['idc'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['vpn'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['x'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['host'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                ...
                elseif ($_POST['type'] == 'y') {
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->datefa >= $_POST['az_tarikh'] && $a->datefa <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['y'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['g'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                    ...
                    if ($all != null) {
                        ...
                        foreach ($all as $a) {
                            ...
                            if ($a->date_farsi >= $_POST['az_tarikh'] && $a->date_farsi <= $_POST['ta_tarikh']) {
                                ...
                                $sendOk['z'] = 'در این بازه زمانی فیلدی موجود نیست';
                                $sendOk['result'] = 0;
                                return $sendOk;
                            }
                ...
                if ($_POST['type'] == 'adsl') {
                    ...
                    if ($pursantadsl != null) {
                        ...
                        foreach ($pursantadsl as $pa) {
                            ...
                            if ($pa->date_farsi >= $_POST['az_tarikh'] && $pa->date_farsi <= $_POST['ta_tarikh']) {
                ...
                elseif ($_POST['type'] == 'y') {
                    ...
                    if ($pursantadsl != null) {
                        ...
                        foreach ($pursantadsl as $pa) {
                            ...
                            if ($pa->datefa >= $_POST['az_tarikh'] && $pa->datefa <= $_POST['ta_tarikh']) {
...
//            if($_POST['ostan'] == 1){
                ...
                if(  $ostan!=null){
                    ...
                    foreach ($ostan as $os){
                       ...
                       $shahr=TblPhone::find()->where(['ostan'=>$os->ostan])->andWhere(['enable'=>'1'])->andWhere(['enableview'=>'1'])->all();
                        if( $shahr!= null){
                            foreach ($shahr as $sh){
...
//                if($_POST['shahr'] == 1){
//
//                    $shahr=TblPhone::find()->where(['ostan'=>$_POST['ostan']])->andWhere(['enable'=>'1'])->andWhere(['enableview'=>'1'])->all();
//
//                    if($shahr!=null){
////return 2;
//
//                        foreach ($shahr as $sh){
//
//                            $markaz=TblPhone::find()->where(['shahr'=>$sh->shahr])->andWhere(['ostan'=>$_POST['ostan']])
//                                ->andWhere(['enable'=>'1'])->andWhere(['enableview'=>'1'])->all();
//                            if( $markaz!=null){
//                                foreach ( $markaz as $m){
//
//                                    $send['ostan']=$_POST['ostan'];
//                                    $send['shahr']=$sh->shahr;
//                                    $send['markaz']=$m->name_markaz;
////                                        $send['vaziyate_forosh']=$m->vaziyat_forosh;
////                                        $send['vaziyat']=$m->vaziyat;
...
//                    if($_POST['markaz'] == 1){
//
//                        $markaz=TblPhone::find()->where(['shahr'=>$_POST['shahr']])->andWhere(['ostan'=>$_POST['ostan']])
//                            ->andWhere(['enable'=>'1'])->andWhere(['enableview'=>'1'])->all();
//                        if( $markaz!=null){
//                            foreach ( $markaz as $m){
//
//                                $send['ostan']=$_POST['ostan'];
//                                $send['shahr']=$_POST['shahr'];
//                                $send['markaz']=$m->name_markaz;
////                                        $send['vaziyate_forosh']=$m->vaziyat_forosh;
////                                        $send['vaziyat']=$m->vaziyat;
//
...
//
//                        $markaz=TblPhone::find()->where(['shahr'=>$_POST['shahr']])->andWhere(['ostan'=>$_POST['ostan']])
//                            ->andWhere(['name_markaz'=>$_POST['markaz']])
//                            ->andWhere(['enable'=>'1'])->andWhere(['enableview'=>'1'])->all();
//                        if( $markaz!=null){
//                            foreach ( $markaz as $m){
//
...
//
//            $date_ir1 = new jdf();
//            $time1 = explode("/", $_POST['az_date_farsi']);
//            $d1 = $time1[0];
//            $m1 = $time1[1];
//            $y1 = $time1[2];
...
//            $g1 = $Y1 . $M1 . $D1;
//
//            $model->az_date = date($g1);
//
//            $date_ir2 = new jdf();
//            $time2 = explode("/", $_POST['ta_date_farsi']);
//            $d2 = $time2[0];
//            $m2 = $time2[1];
//            $y2 = $time2[2];
//            $time22 = $date_ir2->jalaliToGregorian($y2, $m2, $d2);
//
//            $Y2 = $time22[0] . '-';
//            $M2 = $time22[1] . '-';
//            $D2 = $time22[2];
            ...
            if($_POST['az_tarikh'] <= $_POST['ta_tarikh']){
                ...
                if($search!= null){
                    ...
                    foreach ($search as $s){
                        ...
                        if($s->date_farsi >= $_POST['az_tarikh'] && $s->date_farsi <= $_POST['ta_tarikh']){
...
//                return $sendOk;
            ...
            if(  isset($_POST['darkhast']) && $_POST['darkhast']
                ...
                $model->dalil='0';
                if($model->save()){
                    $sendOk1['msg']='عملیات با موفقیت انجام شد.';
                    $sendOk1['result']=1;
                    return $sendOk;
                }
                else{
                    $sendOk1['msg']='عملیات با موفقیت انجام نشد.';
                    $sendOk1['result']=1;
                    return $sendOk;
                }
